...
use Darland\Models\Darland;
/** Class UserManager **/
class DarlandManager {
    ...
    public function find($name, $userId)
    {
        ...
        $stmt->setFetchMode(\PDO::FETCH_CLASS,"Darland\Models\Darland");
    ...
    public function getAll()
    {
        ...
        return $stmt->fetchAll(\PDO::FETCH_CLASS,"Darland\Models\Darland");
    }
}
